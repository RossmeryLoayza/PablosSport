...
class CreateSalePoint extends React.Component {
    ...
    manejadorBoton = async () => {
        ...
        if (name.length !== 0) {
            const UrlCreateSale = "api/pointsofsale/"
            const res = await axios.post(ApiUrl + UrlCreateSale, {
    ...
    render() {
        ...
        if (isCreated === true) {
            console.log("Redirección a los puestos de venta");
                                            ...
                                            <div>
                                                <label
                                                    style={{
                                                        ...
                                                        textAlign: 'left',
                                                        paddingRight: '10px'
                                                    }}> Nombre de Puesto de Venta: </label>
                                                <input
                                                    style={{width: '250px'}}
                                                    name="company"
                                                    type="text"
                                                    placeholder="Ingrese nombre del puesto de venta"
                                            ...
                                            <div>
                                                <a href="#modificar">
                                                    <button type="button" className="btn btn-primary"
                                                            onClick={this.manejadorBoton}>Guardar Puesto de
                                                        Venta
                                                    </button>
                                                </a>
                                            </div>
